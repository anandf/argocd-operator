...
// ArgoCDCommonSpec defines the common fields shared between ArgoCD and ClusterArgoCD
// This struct is embedded in both ArgoCDSpec and ClusterArgoCDSpec to reduce duplication
// +k8s:openapi-gen=true
type ArgoCDCommonSpec struct {

	// ApplicationSet defines whether the Argo CD ApplicationSet controller should be installed.
	...
	// Deprecated: ConfigManagementPlugins field is no longer supported.
	...
	// HelpChatURL is the URL for getting chat help.
	...
	// InitialSSHKnownHosts defines the SSH known hosts data upon creation of the cluster.
	...
	// LocalUsers is a listing of local users to be created by the operator.
	...
	// Deprecated: RepositoryCredentials are the Git pull credentials.
	...
	// DefaultClusterScopedRoleDisabled will disable creation of default ClusterRoles.
	DefaultClusterScopedRoleDisabled bool `json:"defaultClusterScopedRoleDisabled,omitempty"`

	// AggregatedClusterRoles will allow users to have aggregated ClusterRoles.
