...
type ArgoCDSpec struct {
	// Embed all common fields shared with ClusterArgoCD (includes ApplicationSet and Notifications)
	...
	// For migration guidance, see docs/migration/argocd-to-clusterargocd.md
	SourceNamespaces []string `json:"sourceNamespaces,omitempty"`

	// ArgoCDAgent defines configurations for the ArgoCD Agent component.
	// Deprecated: This field is deprecated for namespace-scoped ArgoCD instances and will be removed in a future release.
	// Use ClusterArgoCD for cluster-scoped instances that support ArgoCD Agent.
	// For migration guidance, see docs/migration/argocd-to-clusterargocd.md
